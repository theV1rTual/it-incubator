...
import {VideoType} from "../src/repositories/db";
import {MongoClient} from "mongodb";
dotenv.config()


const dbName = 'back'
const mongoURI = process.env.mongoURI || `mongodb+srv://arystandev_db_user:tB37xiQA2HIAaIi5@cluster0.bjssuw0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`
...
describe('/videos', () => {
  ...
  it('- PUT product by ID with incorrect data', async () => {
    await request(app)
        ...
        .expect(CodeResponsesEnum.NotFound_404)
  ...
  it('+ PUT product by ID with correct data', async () => {
    await request(app)
        ...
        .expect(CodeResponsesEnum.NoContent_204)
